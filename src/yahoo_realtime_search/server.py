...
検索は一度で終わらせる必要はありません。最初の結果に出てきたキーワードや話題をもとに
検索語を変えながら繰り返し検索することで、より広く・深く状況を把握できます。
たとえば、最初は一般的なワードで検索し、結果に多く登場するハッシュタグや固有名詞を
次の検索に使う、英語と日本語の両方で試す、といった使い方が効果的です。
